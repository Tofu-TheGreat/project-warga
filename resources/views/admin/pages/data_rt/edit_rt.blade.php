                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-select" name="agama"
                                                            ...
                                                            <option value="0"
                                                                {{ $show->agama == '0' ? 'selected' : '' }}>Islam</option>
                                                            <option value="1"
                                                                {{ $show->agama == '1' ? 'selected' : '' }}>Kristen
                                                                Protestan</option>
                                                            <option value="2"
                                                                {{ $show->agama == '2' ? 'selected' : '' }}>Kristen Katolik
                                                            </option>
                                                            <option value="3"
                                                                {{ $show->agama == '3' ? 'selected' : '' }}>Khonghucu
                                                            </option>
                                                            <option value="4"
                                                                {{ $show->agama == '4' ? 'selected' : '' }}>Hindu</option>
                                                            <option value="5"
                                                                {{ $show->agama == '5' ? 'selected' : '' }}>Buddha</option>
                                                        </select>
                                                    </div>
                                                    @error('agama')
                                                        {{ $message }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-select" name="status_kependudukan"
                                                    ...
                                                    <option>Pilih di bawah ini</option>
                                                    <option value="0"
                                                        {{ $show->status_kependudukan == '0' ? 'selected' : '' }}>Menetap
                                                    </option>
                                                    <option value="1"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-select" name="peran"
                                                    aria-label="Default select example">
                                                    <option>Pilih di bawah ini</option>
                                                    <option value="rt" {{ $show->peran == 'rt' ? 'selected' : '' }}>RT
                                                    </option>
                                                    <option value="rw" {{ $show->peran == 'rw' ? 'selected' : '' }}>RW
                                                    </option>
                                                </select>
                                            </div>
                                            @error('peran')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-select" name="kewarganegaraan"
                                                    ...
                                                    <option value="0"
                                                        {{ $show->kewarganegaraan == '0' ? 'selected' : '' }}>WNI</option>
                                                    <option value="1"
                                                        {{ $show->kewarganegaraan == '1' ? 'selected' : '' }}>WNA</option>
                                                </select>
                                            </div>
