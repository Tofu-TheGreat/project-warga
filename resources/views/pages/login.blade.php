...
<body>
    <section class="bg-section-login">
        ...
        <div class="svg-frame d-md-block d-none">
            <svg style="--i:0;--j:0;">
                <g id="out1">
                    <path
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form action="/login" method="post">
                                        ...
                                        <div class="d-md-flex d-none align-items-center mb-3 pb-1">
                                            <img src="{{ asset('images/logo-sidawar-nama.png') }}" alt="logo"
                                                height="60">
                                        </div>
                                        <div class="d-flex d-md-none align-items-center pb-1"
                                        ...
                                        <div class="pt-2 mb-4">
                                            <button
                                                class="btn login-button btn-md btn-block text-white rounded-pill d-inline d-sm-none"
                                                style="background-color: #4d6159" type="submit">Kembali</button>
